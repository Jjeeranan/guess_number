...
class _GamePageState extends State<GamePage> {
  ...
  Widget build(BuildContext context) {
    var LightBlueBox = Padding(
      padding: const EdgeInsets.all(8.0),
      child: Container(width: 20, height: 20, color: Colors.lightBlue),
    );
    var indigoBox = Container(width: 20, height: 20, color: Colors.indigo);

    var boxList = <Widget>[];
    for (var i = 0; i < _boxCount; i++) {
      boxList.add(LightBlueBox);
    }
